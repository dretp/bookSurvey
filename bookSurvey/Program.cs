...
namespace SurveyBuilder
{
    ...
    public class Program
    {
        ...
        {
            var survey = new Survey("How much do you like Reading?")
                ...
                .AddQuestion(new MultiPicklistQuestion
                {
                    ...
                    Options = new List<PicklistOption>
                    {
                        new PicklistOption {Text = "Harry Potter", Points = 10},
                        new PicklistOption {Text = "The Giver", Points = 10},
                        new PicklistOption {Text = "How to Kill a MockingBird", Points = 10},
                        new PicklistOption {Text = "The Bible", Points = 10 },
                        new PicklistOption {Text = "The Hunger Games", Points = 10 }

                    }
                })
                .AddQuestion(new SinglePicklistQuestion
                {
                    Label = "How many hours  do you spend Reading a day?",
                    Options = new List<PicklistOption>
                    {
            ...
            Console.WriteLine("Hello! Let's determine how much time you spend reading.");
